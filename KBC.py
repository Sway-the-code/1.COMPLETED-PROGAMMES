...
ques=["Which planet is known as the Red Planet?","Who was the first President of India?","What is the capital of Japan","Which is the largest continent by area?","Who wrote the national anthem of India?",]


opt=[["earth","jupiter","mars","venus"],["rajendra prasad","jawaharlal nehru","bhimrao ambedkar","vallabhbhai patel"],["beijing","seoul","tokyo","bangkok"],["africa","asia","north america","europe"],["rabindranath tagore","bankimchandra chatterjee","mahatma gandhi","subhash chandra bose"]]
